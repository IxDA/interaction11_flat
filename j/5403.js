(function() {
  ...
  var scriptTag = document.getElementById("speakerrate-widget-5403");
  var container = document.createElement("div");
  container.setAttribute('id', 'speakerrate-embed-5403');
  container.innerHTML = "<div style='float: right; padding: 0px 0px 0px 5px'><a href='javascript:void(0)' id='speakerrate-launcher-5403' class='speakerrate-launcher'>Rate Talk</a></div>";

  // Define widget lightbox
  var lightBox = document.createElement('div');
  lightBox.setAttribute('id', 'speakerrate-lightbox-5403');
  lightBox.setAttribute('class', 'speakerrate-lightbox spkr8-widget');
  lightBox.innerHTML = '<div id="speakerrate-wrapper-5403" class="speakerrate-wrapper"><a href="javascript:void(0)" id="speakerrate-close-5403" class="speakerrate-close"></a><iframe src="" id="speakerrate-iframe-5403" class="speakerrate-iframe" allowTransparency="true" scrolling="vertical" frameborder="0"></iframe></div><div id="speakerrate-screen-5403" class="speakerrate-screen"></div>';
  ...
  var widget = {
    modal: document.getElementById('speakerrate-lightbox-5403'),
    frame: document.getElementById('speakerrate-iframe-5403'),
    launcher: document.getElementById('speakerrate-launcher-5403'),
    container: document.getElementById('speakerrate-wrapper-5403'),
    overlay: document.getElementById('speakerrate-screen-5403')
  };

  // Widget close button click
  document.getElementById('speakerrate-close-5403').onclick = function() {
    document.getElementById('speakerrate-lightbox-5403').style.display = 'none';
    return false;
  };
  ...
  widget.launcher.onclick = function() {
    if (widget.modal.parentNode != document.body) {
      ...
      widget.frame.setAttribute("src", "http://speakerrate.com/talks/5403/reviews/new?widget=true"+
